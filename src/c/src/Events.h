...
public:
	...
	int writeOnReqReceivedEvent(char *buf, void *ptrForJavaMsg, const long msg_size, void *ptrForJavaSession);
	int writeOnReplyReceivedEvent(char *buf, void *ptrForJavaMsg, const long msg_size);
