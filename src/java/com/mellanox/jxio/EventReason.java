...
public enum EventReason {
	...
	SESSION_DISCONNECTED(JXIO_GENERAL_ERROR.getIndex() + 13),  // XIO_E_SESSION_DISCONECTED
	...
	BIND_FAILED(JXIO_GENERAL_ERROR.getIndex() + 16),           // XIO_E_BIND_FAILED
	TIMEOUT(JXIO_GENERAL_ERROR.getIndex() + 17),               // XIO_E_TIMEOUT
	IN_PROGRESS(JXIO_GENERAL_ERROR.getIndex() + 18),           // XIO_E_IN_PORGRESS
	INVALID_VERSION(JXIO_GENERAL_ERROR.getIndex() + 19),       // XIO_E_INVALID_VERSION
	NOT_SESSION(JXIO_GENERAL_ERROR.getIndex() + 20),           // XIO_E_NOT_SESSION
	OPEN_FAILED(JXIO_GENERAL_ERROR.getIndex() + 21),           // XIO_E_OPEN_FAILED
	READ_FAILED(JXIO_GENERAL_ERROR.getIndex() + 22),           // XIO_E_READ_FAILED
	WRITE_FAILED(JXIO_GENERAL_ERROR.getIndex() + 23),          // XIO_E_WRITE_FAILED
	CLOSE_FAILED(JXIO_GENERAL_ERROR.getIndex() + 24),          // XIO_E_CLOSE_FAILED
	UNSUCCESSFUL(JXIO_GENERAL_ERROR.getIndex() + 25),          // XIO_E_UNSUCCESSFUL
	MSG_CANCELED(JXIO_GENERAL_ERROR.getIndex() + 26),          // XIO_E_MSG_CANCELED
	MSG_CANCEL_FAILED(JXIO_GENERAL_ERROR.getIndex() + 27),     // XIO_E_MSG_CANCEL_FAILED
	MSG_NOT_FOUND(JXIO_GENERAL_ERROR.getIndex() + 28),         // XIO_E_MSG_NOT_FOUND
	MSG_FLUSHED(JXIO_GENERAL_ERROR.getIndex() + 29),           // XIO_E_MSG_FLUSHED
	MSG_DISCARDED(JXIO_GENERAL_ERROR.getIndex() + 30),         // XIO_E_MSG_DISCARDED
	STATE(JXIO_GENERAL_ERROR.getIndex() + 31),                 // XIO_E_STATE
	NO_USER_BUFS(JXIO_GENERAL_ERROR.getIndex() + 32),          // XIO_E_NO_USER_BUFS
	NO_USER_MR(JXIO_GENERAL_ERROR.getIndex() + 33),            // XIO_E_NO_USER_MR
	USER_BUF_OVERFLOW(JXIO_GENERAL_ERROR.getIndex() + 34),     // XIO_E_USER_BUF_OVERFLOW
	REM_USER_BUF_OVERFLOW(JXIO_GENERAL_ERROR.getIndex() + 35), // XIO_E_REM_USER_BUF_OVERFLOW
	TX_QUEUE_OVERFLOW(JXIO_GENERAL_ERROR.getIndex() + 36),     // XIO_E_TX_QUEUE_OVERFLOW
	USER_OBJ_NOT_FOUND(JXIO_GENERAL_ERROR.getIndex() + 37),    // XIO_E_USER_OBJ_NOT_FOUND
	LAST_STATUS(JXIO_GENERAL_ERROR.getIndex() + 37);           // XIO_E_LAST_STATUS
