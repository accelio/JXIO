...
export LD_LIBRARY_PATH=$DIR
echo -e "\nRunning client test....\n"
java -Dlog4j.configuration=com/mellanox/jxio/tests/log4j.properties.jxiotest -cp "../bin/jxio.jar:../src/lib/commons-logging.jar:../src/lib/log4j-1.2.15.jar:." com.mellanox.jxio.tests.TestClient $IP $PORT $TEST_NUMBER
