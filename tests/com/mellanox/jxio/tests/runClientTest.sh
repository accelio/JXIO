...
export LD_LIBRARY_PATH=$DIR
echo -e "\nRunning client test....\n"
#java -classpath jx.jar:. com.mellanox.jxio.tests.TestClient $IP $PORT $TEST_NUMBER
java -Dlog4j.configuration=log4j.properties.jxiotest -cp "jx.jar:../../../../../lib/commons-logging.jar:../../../../../lib/log4j-1.2.15.jar:." com.mellanox.jxio.tests.TestClient $IP $PORT $TEST_NUMBER
