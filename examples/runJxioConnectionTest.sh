...
javac -cp "../bin/jxio.jar:$../src/lib/commons-logging.jar" ./com/mellanox/jxio/tests/benchmarks/jxioConnection/InputStreamServer.java ./com/mellanox/jxio/tests/benchmarks/jxioConnection/InputStreamClient.java ./com/mellanox/jxio/tests/benchmarks/jxioConnection/ServerReader.java
if [[ $? != 0 ]] ; then
    exit 1
fi
