...
public:
	...
	int writeOnReqReceivedEvent(char *buf, void *ptrForJavaMsg, void *ptrForJavaSession,
			struct xio_msg *msg, int type);
	int writeOnReplyReceivedEvent(char *buf, void *ptrForJavaMsg, struct xio_msg *msg, int type);
